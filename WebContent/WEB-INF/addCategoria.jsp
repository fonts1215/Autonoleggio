	...
	<div class="container-fluid">
		<div class="col-12">
			<div class="bd-example">
				<form action="AddCategoria" onsubmit=" return validateForm()" method="post">
					
					<div class="form-group">
						<label for="exampleInputEmail1">Inserisci nome categoria</label> <input type="text"
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Tariffa giornaliera</label> <input type="text"
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Tariffa settimanale</label> <input type="text"
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Tariffa mensile </label> <input type="text"
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Descrizione</label> <input type="text"
